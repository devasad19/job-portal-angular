	...
	jQuery(document).ready(function ($) {
		...
		*/
        ...
        $(document).ready(function() {
		    $('#postedjob-datatable').DataTable();
		});

        $(document).ready(function() {
		    $('#draftedjob-datatable').DataTable();
		});

        $(document).ready(function() {
		    $('#archivedjob-datatable').DataTable();
		});

        $(document).ready(function() {
		    $('#applicants-list-datatable').DataTable();
		});
        ...
        // ****************************************
        $(document).ready(function() {
		    $('.openRegiPage').on('click', function(){
